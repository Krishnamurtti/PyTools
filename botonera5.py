...
BoxLayout:
    ...
    ScrollView:
        ...
        MDBoxLayout:
            ...
            # Fila 1: Inicio/Creación/Finalización para DEF y ATQ
            GridLayout:
                cols: 6
                size_hint_y: None
            ...
            # Banda inferior de categorías (TR/ABP)
            GridLayout:
                cols: 4
                spacing: "2dp"
                size_hint_y: None
            ...
            # Línea de ABP izquierda / derecha
            GridLayout:
                cols: 7
                spacing: "2dp"
                size_hint_y: None
            ...
            # Atajos de categoría principales
            GridLayout:
                cols: 3
                spacing: "6dp"
                size_hint_y: None
...
class BotoneraApp(MDApp):
    ...
    def _insert_click(self, category, descriptor):
        ...
        c.execute(
            "INSERT INTO clicks (ts, half, ms_from_start, category, descriptor) VALUES (?, ?, ?, ?, ?)",
    ...
    def _insert_lap(self, label):
        ...
        ms = int(self.sw_seconds * 1000)
        c.execute(
            "INSERT INTO laps (ts, ms_from_start, label) VALUES (?, ?, ?)",
            (now, ms, label)
        )
        conn.commit(); conn.close()
